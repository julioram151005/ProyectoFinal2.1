...
public class AsignacionService {
    private static final String BASE_URL = "https://proyectoprogramacion2-1.onrender.com/api/asignacion";
    ...
    public Asignacion createAsignacion(Asignacion m) throws Exception {
        try (CloseableHttpClient client = HttpClients.createDefault()) {
    ...
    public Asignacion updateAsigancio(int id, Asignacion m) throws Exception {
        try (CloseableHttpClient client = HttpClients.createDefault()) {
